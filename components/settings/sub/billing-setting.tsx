...
>(({ className, ...props }, ref) => {
  ...
  const updateSubscription = useMutation(api.function.users.updateSubscribtion);
          ...
          <CardBody className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Icon className="h-6 w-6 text-primary-500" icon="mdi:crown" />
                <div>
