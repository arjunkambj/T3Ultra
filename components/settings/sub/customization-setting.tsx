...
const CustomizationSetting = React.forwardRef<
  HTMLDivElement,
  CustomizationSettingCardProps
>(({ className, ...props }, ref) => {
  const user = useUser();
  ...
  return (
    <div ref={ref} className={cn("p-2", className)} {...props}>
      ...
      <div>
        ...
        <div className="mt-4 space-y-4">
          ...
          <Textarea
            ...
            onChange={(e) =>
              setFormData((prev) => ({ ...prev, whatuserdoes: e.target.value }))
            }
          />
        </div>
      </div>
      ...
      <div>
        ...
        <p className="mt-1 text-sm font-normal text-default-400">
          Select traits you&apos;d like the AI to exhibit when interacting with
          you.
        </p>
      ...
      {/* Additional Context */}
      <div>
        <p className="text-base font-medium text-default-700">Anything Else?</p>
        <p className="mt-1 text-sm font-normal text-default-400">
          Share any additional context, preferences, or special instructions.
        </p>
        ...
        <Textarea
          ...
          onChange={(e) =>
            setFormData((prev) => ({ ...prev, anythingelse: e.target.value }))
          }
        />
      </div>
          ...
          <Card className="mt-4 bg-default-100" shadow="none">
            <CardBody className="p-4">
              <div className="space-y-3 text-sm">
                {formData.whattocalluser && (
                  <div>
                    <span className="font-medium text-default-600">Name: </span>
                ...
                {formData.whatuserdoes && (
                  <div>
                    <span className="font-medium text-default-600">Role: </span>
                    <span className="text-default-500">
                      {formData.whatuserdoes}
                    </span>
                  </div>
