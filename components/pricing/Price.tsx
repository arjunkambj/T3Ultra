...
export default function Component() {
  ...
  return (
    <div className="relative flex max-w-4xl flex-col items-center py-12">
      ...
      >
        <div
          className="mx-auto aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-primary-500 to-primary-600 opacity-30"
          style={{
            clipPath:
      ...
      <div className="flex max-w-xl flex-col text-center">
        ...
        <Spacer y={4} />
        <h2 className="text-large text-default-800">
      ...
      <div className="mb-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {tiers.map((tier) => (
          <Card
            key={tier.key}
            isBlurred
            className={cn("bg-default-100/60 p-3 dark:bg-default-100/50", {
          ...
          >
            ...
            <CardBody className="gap-8">
              <p className="flex items-baseline gap-1 pt-2">
                <span className="inline bg-clip-text text-4xl font-semibold leading-7 tracking-tight text-default-900 text-transparent">
